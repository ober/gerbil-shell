...
|---------------------|-----------------------------------|-----------|-----------|
| smoke               | Basic shell operations            | **18/18** | 17/18     |
| pipeline            | Pipe operator and pipelines       | 25/26     | 22/26     |
| redirect            | I/O redirection (>, <, >>, etc.)  | 38/41     | 38/41     |
...
| exit-status         | Exit status and $?                | 9/11      | 6/11      |
...
| word-eval     | Word evaluation and expansion                 | **8/8** | 7/8       |
...
| var-op-test   | Variable operators (${var:-default}, etc.)    | 33/37   | 34/37     |
...
| Suite           | Description                                 | bash      | gsh       |
|-----------------|---------------------------------------------|-----------|-----------|
| arith           | Arithmetic expansion $(( )) and (( ))       | 61/74     | 69/74     |
